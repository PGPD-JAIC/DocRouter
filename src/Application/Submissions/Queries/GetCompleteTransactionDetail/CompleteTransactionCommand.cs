...
{
    /// <summary>
    /// Viewmodel class used to handle a command to complete a transaction.
    /// </summary>
    public class CompleteTransactionCommand : IMapFrom<SubmissionTransaction>, IRequest<Result>
    {
        /// <summary>
        ...
        {
            profile.CreateMap<SubmissionTransaction, CompleteTransactionCommand>()
